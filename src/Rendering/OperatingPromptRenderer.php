...
final readonly class OperatingPromptRenderer
{
    ...
    private function renderL2(array $facts, bool $hasL1Contracts): string
    {
        $md = [
            ...
            '- If required verification cannot be performed or observed under the current constraints, keep the result `UNKNOWN` or `BLOCKED` and name the missing evidence or smallest contract change. Do not weaken the requirement to manufacture success.',
